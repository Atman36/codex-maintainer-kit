...
PR Factory Kit — многоагентный пайплайн для автоматической подготовки Pull Request-ов. Фреймворк анализирует репозиторий, находит наиболее вероятные к merge улучшения, реализует их и формирует готовый PR.
